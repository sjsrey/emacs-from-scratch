...
#+begin_src emacs-lisp
    ...
    (use-package org
      ...
      (setq org-agenda-custom-commands '(
                                         ...
                                         ("Aw" tags-todo "+PRIORITY=\"A\"+writing")
                                         ("Ab" tags-todo "+PRIORITY=\"A\"+book")
                                         ("Ap" tags-todo "+PRIORITY=\"A\"+paper")
                                         ("Ag" tags-todo "+PRIORITY=\"A\"+grants")
                                         ("Ac" tags-todo "+PRIORITY=\"A\"+code")
                                         ("As" tags-todo "+PRIORITY=\"A\"+service")
                                         ("At" tags-todo "+PRIORITY=\"A\"+teaching")
                                         ("Af" tags-todo "+PRIORITY=\"A\"+personal")
                                         ("g" . "Goals granular")
                                         ("ga" tags-todo "+q3+2021")
                                         ("gw" tags-todo "+q3+2021+work")
                                         ("gp" tags-todo "+q3+2021+personal")
                                       ("e" "emails"
                                        ((tags "email"
                                               (
                                       ...
                                       ("G" "GOAL"
                                        ((tags "q3+2021"
                                               (
                                                ...
                                                (org-agenda-sorting-strategy
                                                 '(deadline-up))
                                                (org-agenda-overriding-header "Q GOALS")))
                                         ))
  ...
  (setq org-capture-templates '(
                               ("p" "Protocol" entry (file+headline "~/Dropbox/org/gtd/gtd.org" "Inbox")
                                "* TODO %^{Title}\nSource: %u, %c\n #+BEGIN_QUOTE\n%i\n#+END_QUOTE\n\n\n%?")
                               ("L" "Protocol Link" entry (file+headline "~/Dropbox/org/gtd/gtd.org" "Inbox")
                                "* TODO %? \n[[%:link][%:description]] \nCaptured On: %U")
                               ("t" "todo" entry (file+headline "~/Dropbox/org/gtd/gtd.org" "Inbox")
                                "* TODO  %?\n \n%a\n")
                               ("T" "tickler" entry (file+headline "~/Dropbox/org/gtd/tickler.org" "Tasks")
                                "* %?\n %(org-insert-time-stamp (org-read-date nil t \"+0d\"))\n%a\n")
                                ("e" "Current file log entry" entry (file+olp+datetree buffer-file-name)
                                 "* %? \n%u")
                               ("b" "Book" entry (file+headline "~/Dropbox/org/gtd/books.org" "Reading")
                                (file "~/Dropbox/org/tpl-book.txt"))
                               ("r" "Referee" entry (file+headline "~/Dropbox/org/gtd/gtd.org" "Tasks Referee")
                                (file "~/Dropbox/org/tpl-referee.txt"))
                               ("w" "Review: Weekly Review" entry (file+olp+datetree "~/Dropbox/org/reviews.org")
                                (file "~/Dropbox/org/tpl-review.txt"))
                               ("W" "Planning: Weekly MIT" entry (file+olp+datetree "~/Dropbox/org/mit.org")
                                (file "~/Dropbox/org/tpl-weekly-planning.txt"))
                               ("m" "Meeting" entry (file+olp+datetree "~/Dropbox/org/gtd/meetings.org")
...
#+begin_src emacs-lisp
      ...
      ;; org-roam-ui
      ;; instructions at  https://github.com/org-roam/org-roam-ui#manually
      ;; 
...
* Org-protocol
A key part of a task system is capturing tasks from email.

A good [[https://mediaonfire.com/blog/2017_07_21_org_protocol_firefox.html][description]] for setting this up.

This works well with firefox for me.
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c e")
                   (lambda () (interactive) (find-file "~/projects/emacs-from-scratch/Emacs.org")))
